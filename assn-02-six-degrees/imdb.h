...
class imdb {
 ...
 public:
   ...
   *
   * @param directory the comp_data of the directory housing the formatted information backing the imdb.
   */
   ...
   *
   * @param player the comp_data of the actor or actresses being queried.
 ...
 private:
  ...
  static int compare_actors(const void * a1, const void * a2);
  static int compare_movies(const void * m1, const void * m2);
